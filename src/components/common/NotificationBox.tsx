  ...
  const getIcon = (type: Notification["type"]) => {
    switch (type) {
      ...
      case "achievement_earned":
        return <FiCheck className="text-forge-ember" />;
      case "warning":
      case "payment_sent":
        return <FiAlertTriangle className="text-forge-ember" />;
      case "error":
      case "gig_rejected":
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
              {notifications.filter((n) => !n.read).length > 0 && (
                <button
                  ...
                  className="text-xs sm:text-sm text-forge-ember hover:text-forge-ember transition-colors whitespace-nowrap"
                >
                    ...
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-1 gap-2">
                          ...
                          {!notification.read && (
                            <div className="w-2 h-2 bg-forge-ember rounded-full flex-shrink-0 mt-1" />
                          )}
                        </div>
                        <p
                        ...
                        <div className="flex items-center justify-between mt-2 gap-2">
                          ...
                          {notification.username && (
                            <span className="text-xs text-forge-ember truncate flex-shrink-0">
                              @{notification.username}
                            </span>
                          )}
                        </div>
